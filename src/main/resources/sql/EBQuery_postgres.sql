...
-- Name: database_connections_id_seq; Type: SEQUENCE; Schema: public; Owner: Y77CH
--
...
-- Dependencies: 170
-- Name: database_connections_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Y77CH
--
...
-- Name: queries; Type: TABLE; Schema: public; Owner: Y77CH; Tablespace: 
--
...
-- Name: queries_id_seq; Type: SEQUENCE; Schema: public; Owner: Y77CH
--
...
-- Dependencies: 172
-- Name: queries_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Y77CH
--
...
-- Name: query_versions; Type: TABLE; Schema: public; Owner: Y77CH; Tablespace: 
--
...
-- Name: query_versions_id_seq; Type: SEQUENCE; Schema: public; Owner: Y77CH
--
...
-- Dependencies: 174
-- Name: query_versions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: Y77CH
--
...
-- Name: id; Type: DEFAULT; Schema: public; Owner: Y77CH
--
...
-- Name: database_connections_pkey; Type: CONSTRAINT; Schema: public; Owner: Y77CH; Tablespace: 
--
...
-- Name: queries_pkey; Type: CONSTRAINT; Schema: public; Owner: Y77CH; Tablespace: 
--
...
-- Name: query_versions_pkey; Type: CONSTRAINT; Schema: public; Owner: Y77CH; Tablespace: 
--
...
-- Name: unique_key; Type: INDEX; Schema: public; Owner: Y77CH; Tablespace: 
--
...
-- Name: queries_database_connection_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Y77CH
--
...
-- Name: query_versions_query_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: Y77CH
--
